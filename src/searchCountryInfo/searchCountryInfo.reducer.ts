...
export const countryInfoReducer = reducerWithInitialState(countryInfoInitialState)
  ...
  .case(SearchFormAction.searchCountryInfoLoadingRequest, (state, payload) => {
    return {
        ...state,
        loading: payload
    };
  })
  .case(SearchFormAction.searchCountryInfoSuccessRequest, (state, payload) => {
    return {
        ...state,
        loading: payload
    };
